...
insert into moto (id,matricula, marca, modelo, tipo_moto, kilometros_recorridos, precio_alquiler) values (4,'GHJ56Y', 'SUZUKI', 2015, 'ENDURO',0,140000);
...
insert into alquiler (id,fecha_alquiler, fecha_entrega,valor_pago,cliente_id,moto_id) values (3,'2021-03-09', '2021-03-12',150000,1,2);
